...
.gn-logo {
  ...
  height: 60px;
  width: 60px;
  background-image: url('Imagenes/logoSena1.png'); /* Ruta de la imagen */
...
<body>
  <div class="container">
    ...
    <li><a class="codrops-icon codrops-icon-drop" href="../../../Inicio/Index.php"><img src="..\Imagenes\logoSena1.jpg" ></a></li>
