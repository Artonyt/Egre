...
.gn-logo {
  ...
  height: 60px;
  width: 60px;
  background-image: url('Imagenes/Sena_Colombia_logo.jpg'); 
...
<body>
  <div class="container">
    ...
    <li><a class="codrops-icon codrops-icon-drop" href="../Inicio/Index.php"><img src="Imagenes/Sena_Colombia_logo.jpg" ></a></li>
